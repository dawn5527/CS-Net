...
class nnUNetTrainer(NetworkTrainer):
    ...
    def setup_DA_params(self):
        ...
        # dawn changed here
        self.data_aug_params['selected_seg_channels'] = [1]
    ...
    def process_plans(self, plans):
        ...
        # kits
        # self.batch_size = 8
        # self.patch_size = np.array([512, 512]).astype(int)
    ...
    def preprocess_patient(self, input_files):
        ...
        :return:
        """
        from preprocessing.preprocessing import GenericPreprocessor, PreprocessorFor2D
        if self.threeD:
