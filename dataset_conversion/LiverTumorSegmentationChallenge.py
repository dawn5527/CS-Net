...
if __name__ == "__main__":
    ...
    def load_save_train(args):
        ...
        pat_id = "train_" + pat_id.split("_")[0]
    ...
    for patient in os.listdir(train_dir):
        nii_files_tr_data.append(os.path.join(train_dir,patient,patient+'_lits.nii'))
        nii_files_tr_seg.append(os.path.join(train_dir,patient,patient+'_seg.nii'))
